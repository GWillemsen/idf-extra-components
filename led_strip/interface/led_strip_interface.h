...
struct led_strip_t {
     ...
     */
    esp_err_t (*reverse_insert_pixel)(led_strip_t *strip, uint32_t index, uint32_t red, uint32_t green, uint32_t blue);
     ...
     *      - ESP_FAIL: Failed to push the pixel into the led strip because some other error occurred
     */
    esp_err_t (*reverse_insert_pixel_rgbw)(led_strip_t *strip, uint32_t index, uint32_t red, uint32_t green, uint32_t blue, uint32_t white);
     ...
     */
    esp_err_t (*insert_pixel)(led_strip_t *strip, uint32_t index, uint32_t red, uint32_t green, uint32_t blue);
     ...
     *      - ESP_FAIL: Failed to push the pixel into the led strip because some other error occurred
     */
    esp_err_t (*insert_pixel_rgbw)(led_strip_t *strip, uint32_t index, uint32_t red, uint32_t green, uint32_t blue, uint32_t white);
